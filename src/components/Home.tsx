    ...
    <div className="w-full flex flex-col text-center items-center justify-center gap-3 mt-16">
      ...
      <div className="flex gap-2 item">
        <Button className="border-none bg-violet-800">
          <a
            href="https://www.linkedin.com/in/fs-ferreiraa/"
            target="_blank"
            tabIndex={-1}
        ...
        <Button className="border-none bg-violet-800">
          <a
            href="https://github.com/fs-ferreira"
            target="_blank"
            tabIndex={-1}
            rel="noopener noreferrer"
          >
        ...
        <Button className="border-none bg-violet-800">
          <a
            href="https://www.instagram.com/feli_pih/"
            target="_blank"
            tabIndex={-1}
            rel="noopener noreferrer"
          >
      ...
      <a href={CV_ptBR} download="CV - Felipe da Silva Ferreira" tabIndex={-1}>
        <Button className="font-semibold border-none hocus:scale-105 hocus:bg-transparent">
          or download in pt-BR
        </Button>
      </a>
    </div>
  );
